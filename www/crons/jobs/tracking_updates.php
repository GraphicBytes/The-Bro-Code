...
if ($saved_date != $new_date) {
  ...
  $db->sql("INSERT INTO track_daily_totals SET the_date=?, unique_t=?, unique_mp=?, unique_lp=?, hits_t=?, hits_mp=?, hits_lp=?, bot_u=?, bot_t=?", "sssssssss", $saved_date, $unique_t , $unique_mp , $unique_lp , $hits_t , $hits_mp , $hits_lp , $bot_u , $bot_t );
  ...
  echo "TRACKING LOGGING NOT RUN<br />";
  echo "<br /><br />";
}
