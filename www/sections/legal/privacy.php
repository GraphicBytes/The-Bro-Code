<?php
$pagetitle = "Brocode.org Privacy Policy";
$pagedescription = "Brocode.org Privacy Policy";
$canonical = "https://brocode.org/privacy/";
$nofollow = 1;
$sfw = 2;
...
<div class="container">
  ...
  <main class="content">
    <div class="content-block bg bottom-padding">
      ...
      <p>This privacy policy is for this website brocode.org and served by The Bro Code and governs the privacy of its users who choose to use it.</p>
      ...
      <p>This website and its owners take a proactive approach to user privacy and ensure the necessary steps are taken to protect the privacy of its users throughout their visiting experience. This website complies to all US/UK/EU laws and requirements for user privacy.</p>
      ...
      <p>To have your personal data removed from this platform, simply email us at <a href="mailto:bfam@brocode.org">bfam@brocode.org</a> and we will remove it within 48 hours.</p>

      <p>If you used the social media login functions or an email account different from the one you used to sign up to this platform, please include as much detail as possible so we can identify you at the genuine owner of the data you are requesting to have removed.</p>
    </div>
  </main>
