<?php
$pagetitle = "Brocode.org Terms Of Use";
$pagedescription = "Brocode.org Terms Of Use";
$canonical = "https://brocode.org/terms/";
$sfw = 2;
$nofollow = 1;
...
<div class="container">
  ...
  <main class="content">
    ...
    <div class="content-block bg">
      ...
      <h2>Welcome to brocode.org</h2>
      <p>These terms and conditions outline the rules and regulations for the use of the brocode.org website.</p>
      <p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use the brocode.org website
      ...
      <h2>Cookies</h2>
      <p>We employ the use of cookies. By using the brocode.org website you consent to the use of cookies
        in accordance with the brocode.org privacy policy.</p>
      ...
      <ul>
        ...
        <li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information,
          material and data ('Comments') in areas of the website. brocode.org does not screen, edit, publish
          or review Comments prior to their appearance on the website and Comments do not reflect the views or
          opinions of brocode.org, its agents or affiliates. Comments reflect the view and opinion of the
          person who posts such view or opinion. To the extent permitted by applicable laws brocode.org shall
          ...
          website.</li>
        <li>brocode.org reserves the right to monitor all Comments and to remove any Comments which it considers
        ...
        <li>You hereby grant to <strong>brocode.org</strong> a non-exclusive royalty-free license to use, reproduce,
      ...
      <p>We will approve link requests from these organizations if we determine that: (a) the link would not reflect
        ...
        the visibility associated with the hyperlink outweighs the absence of brocode.org; and (d) where the
      ...
      <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website,
        you must notify us by sending an e-mail to <a href="mailto:bfam@brocode.org" title="send an email to bfam@brocode.org">bfam@brocode.org</a>.
      ...
      <p>No use of the brocode.org logo or other artwork will be allowed for linking absent a trademark license
        agreement.</p>
      <h2>Iframes</h2>
