...
//get the content
$mysqlquery3 = "SELECT id, topic_id, content FROM topic_replies WHERE id='$typea' ORDER BY id DESC LIMIT 1";
...
if ($warnings > 2) {
  ...
  include($php_base_directory . '/sections/system/includes/delete_replies.php');
}
