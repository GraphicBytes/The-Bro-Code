...
$mysqlquery_child_replies = "SELECT *, up_votes-down_votes as rating FROM variant_comments WHERE code_id='$code_id' AND parent='$scenario_id' AND child='0' $sfw_sql $hide_shit_sql ORDER BY $orderby_sql";
...
<div class="children-<?php echo $scenario_id; ?>" style="display:none;">
  <div class="children-container children-container-<?php echo $scenario_id; ?>">
    ...
    while ($child_row = $child_res->fetch_assoc()) {
      ...
      if ($logged_in_id > 0) {
        $vote = 2;
        $mysqlquery2 = "SELECT * FROM variant_comment_ratings WHERE user_id='$logged_in_id' AND example_id='$child_scenario_id' ORDER BY id DESC";
      ...
      //get infants
      $mysqlquery_infant_replies = "SELECT *, up_votes-down_votes as rating FROM variant_comments WHERE code_id='$code_id' AND child='$child_scenario_id' $sfw_sql $hide_shit_sql ORDER BY post_time ASC, id ASC";
      ...
      <div class="comment comment-box-<?php echo $child_scenario_id; ?> child border-top">
        ...
        <span class="meta border-top">
          <span class="meta-left meta-replies">
            <?php if ($logged_in_id > 0 && $total_infant_replies < 1 && $post_status < 3) { ?>
          ...
          <span class="meta-right code-meta-rating-<?php echo $child_scenario_id; ?>">

            <?php if ($logged_in_id > 0 && $child_scenario_owner_id != $logged_in_id && $post_status < 3) { ?>
            ...
            <?php if ($child_scenario_owner_id == $logged_in_id && $post_status < 3) { ?>
