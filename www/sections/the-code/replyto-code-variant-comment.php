...
if ($character_count > 1000) {
  ...
  $mysqlquery = "INSERT INTO variant_comments SET
  ...
  $mysqlquery = "UPDATE variant_comments SET last_update='$post_time' WHERE id='$parent_id'";
  $dbconn->query($mysqlquery);
...
?>
    ...
    <div class="comment comment-box-<?php echo $scenario_id; ?> brand-new border-bottom <?php if ($child_id > 0) {
                                                                                          echo "infant";
                                                                                        } else {
                                                                                          echo "child";
                                                                                        } ?>">
