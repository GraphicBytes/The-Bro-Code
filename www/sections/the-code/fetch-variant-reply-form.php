...
<div class="comment child reply-form-container-<?php echo $scenario_id; ?>" style="display:none;">
  ...
  <form method="post" class="reply-form reply-form-<?php echo $scenario_id; ?>" action="<?php echo $base_url; ?>/replyto-code-variant-comment/<?php echo $code_id; ?>/<?php echo $scenario_id; ?>/" enctype="multipart/form-data">
